"""
Django settings for tkf_notes_41900 project.
...
ROOT_URLCONF = 'tkf_notes_41900.urls'
...
WSGI_APPLICATION = 'tkf_notes_41900.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "tkf_notes_41900 API",
    "DESCRIPTION": "API documentation for tkf_notes_41900 App",
    "VERSION": "v1",
}
